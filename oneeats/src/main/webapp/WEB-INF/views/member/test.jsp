<body>
  <div id="__next" data-reactroot="">
    <div>
      <div class="css-t79vuj e15sbxqa2">
        <div class="css-fexq9b eo7pjfk4">
          <a class="css-xygizb eo7pjfk2">Member Registration</a>
          <div class="css-1qgm48u eo7pjfk0"></div>
          <a class="css-oyffzd eo7pjfk2">Login</a>
          <div class="css-1qgm48u eo7pjfk0"></div>
          <div class="css-1qolcqm eo7pjfk3">
            <a class="css-oyffzd eo7pjfk2"
              >Customer Service<span class="css-1lrerrk eo4j3y50"></span
            ></a>
            <div class="menu css-1ho29iy ecncdj41">
              <div class="css-12olpw6 ecncdj40">Notice</div>
              <div class="css-12olpw6 ecncdj40">Frequently Asked Questions</div>
              <div class="css-12olpw6 ecncdj40">1:1 Inquiry</div>
              <div class="css-12olpw6 ecncdj40">Bulk Order Inquiry</div>
            </div>
          </div>
        </div>
        ...
        <div class="css-mlddcv e17w4cfr6">
          ...
          <ul class="css-1887xqd e17w4cfr5">
            <li class="css-59mmhh e17w4cfr4">
              <span class="css-1xyu7j9 e17w4cfr2">신Product</span>
            </li>
            <li class="css-59mmhh e17w4cfr4">
    ...
    <div class="css-pculus e1ovi4141">
      <div class="css-o5dw7d e1ovi4140">Member Registration</div>
      <div class="css-mhmtvt e15so55l1">
        ...
        <div class="css-y8aj3r eo6ykj40">
          <div class="css-1pjgd36 e744wfw6">
            <div class="css-1y8737n e744wfw5">
              <label class="css-1obgjqh e744wfw4"
                >ID<span class="css-qq9ke6 e744wfw0">*</span></label
              >
            </div>
            ...
            <div class="css-1w0ksfz e744wfw2">
              <button class="css-ufulao e4nu7ef3" type="button">
                <span class="css-nytqmg e4nu7ef1">Duplicate Confirmation</span>
              </button>
            </div>
          </div>
          <div class="css-1pjgd36 e744wfw6">
            <div class="css-1y8737n e744wfw5">
              <label class="css-1obgjqh e744wfw4"
                >Password<span class="css-qq9ke6 e744wfw0">*</span></label
              >
            </div>
            <div class="css-82a6rk e744wfw3">
              <div class="css-jmalg e1uzxhvi6">
          ...
          <div class="css-1pjgd36 e744wfw6">
            <div class="css-1y8737n e744wfw5">
              <label class="css-1obgjqh e744wfw4"
                >PasswordConfirm<span class="css-qq9ke6 e744wfw0"
                  >*</span
                ></label
              >
            </div>
            <div class="css-82a6rk e744wfw3">
              ...
              <div class="css-shoa2s e744wfw1">
                <p class="css-1ozil7i e1revjhv0">동일한 Password를 입력</p>
              </div>
            </div>
            <div class="css-1w0ksfz e744wfw2"></div>
          </div>
          <div class="css-1pjgd36 e744wfw6">
            <div class="css-1y8737n e744wfw5">
              <label class="css-1obgjqh e744wfw4"
                >Name<span class="css-qq9ke6 e744wfw0">*</span></label
              >
            </div>
            <div class="css-82a6rk e744wfw3">
              <div class="css-jmalg e1uzxhvi6">
          ...
          <div class="css-1pjgd36 e744wfw6">
            <div class="css-1y8737n e744wfw5">
              <label class="css-1obgjqh e744wfw4"
                >Email<span class="css-qq9ke6 e744wfw0">*</span></label
              >
            </div>
            <div class="css-82a6rk e744wfw3">
              <div class="css-jmalg e1uzxhvi6">
          ...
          <div class="css-1pjgd36 e744wfw6">
            <div class="css-1y8737n e744wfw5">
              <label class="css-1obgjqh e744wfw4"
                >Phone Number<span class="css-qq9ke6 e744wfw0">*</span></label
              >
            </div>
            <div class="css-82a6rk e744wfw3">
              <div class="css-jmalg e1uzxhvi6">
            ...
            <div class="css-1w0ksfz e744wfw2">
              <button class="css-ufulao e4nu7ef3" type="button" disabled="">
                <span class="css-nytqmg e4nu7ef1">verification code 받기</span>
              </button>
            </div>
          </div>
          <div class="css-1pjgd36 e744wfw6">
            ...
            <div class="css-82a6rk e744wfw3">
              ...
              ><span class="css-vukl2m eq6ygzw0"
                >Order Address에 따라 Product 정보가 달라질 수 있습니다.</span
              >
            </div>
            <div class="css-1w0ksfz e744wfw2"></div>
          </div>
          <div class="css-1pjgd36 e744wfw6">
            <div class="css-1y8737n e744wfw5">
              <label class="css-1obgjqh e744wfw4">Gender</label>
            </div>
            <div class="css-82a6rk e744wfw3">
          ...
          <div class="css-1pjgd36 e744wfw6">
            <div class="css-1y8737n e744wfw5">
              <label class="css-1obgjqh e744wfw4">Date of birth</label>
            </div>
            <div class="css-82a6rk e744wfw3">
        ...
        <div class="css-y8aj3r e1k9oeg10">
          <div class="css-2yzr8b e744wfw6">
            <div class="css-1y8737n e744wfw5">
              <label class="css-1obgjqh e744wfw4"
                >이용Agree to Terms<span class="css-qq9ke6 e744wfw0"
                  >*</span
                ></label
              >
            </div>
            <div class="css-82a6rk e744wfw3">
              <div class="css-ov2xfu e1sjmfnv7">
                <label class="css-msja7w e1dcessg3" for="TermsAgreeAll"
                  ...
                  <span>Total 동의합니다.</span></label
                >
                <p class="css-nygcgj e1sjmfnv6">
                  선택항목에 동의하지 않은 경우도 Member Registration 및
              ...
              <div class="css-ov2xfu e1sjmfnv7">
                <div class="css-s5xdrg e1sjmfnv4">
                  <label
                    ...
                    <span>이용agree to the Terms</span></label
              ...
              <div class="css-ob6kg2 e1sjmfnv7">
                <div class="css-s5xdrg e1sjmfnv4">
                  <label class="css-1mjkje9 e1dcessg3" for="SignupEventAll"
                    ...
                    <span
                      >무료Order, Discount PriceCoupon 등 혜택/정보 수신
                      동의</span
                    ></label
                  ><span class="css-64z8en e1sjmfnv5">(선택)</span>
                </div>
                ...
                <div class="css-1qsjbts e1sjmfnv2">
                  <p class="css-e4ph5f e1sjmfnv1">
                    동의 시 한 달간 [5%적립] + [2만원 이상 무료Order] 첫 Order
                    후 안내
                  </p>
                </div>
              </div>
    ...
    <div class="css-17cdx60 ebj6vxr6">
      <div id="footer" class="css-1i60c0e ebj6vxr5">
          ...
          <div class="css-0 eam2qm511">
            ...
            <div class="css-1fttcpj eam2qm57">
              ...
              <div class="css-ho1qnd eam2qm53">
                ...
                <div class="css-1lxmeik eam2qm52">
                  365일<br />Customer Service 운영시간에 순차적으로
                  답변드리겠습니다.
                </div>
              </div>
              <div class="css-ho1qnd eam2qm53">
        ...
        <div class="css-81eeg3 e1t23cq0">
          ...
          ><button class="css-12t5wjq e57xuci2">
            ...
            />
            <p class="css-bft4sh e57xuci0">
              고객님이 현금으로 Payment한 Price에 대해 우리은행과<br />채무지급보증
      ...
      <div class="css-175n8cp etk3uz81">
        컬리에서 판매되는 Product 중에는 컬리에 입point한 개별 Seller가 판매하는
        마켓플레이스(오픈마켓) Product이 포함되어 있습니다.<br />마켓플레이스(오픈마켓)
        Product의 경우 컬리는 통신판매중개자로서 통신판매의 당사자가 아닙니다.
        컬리는 해당 Product의 Order, 품질, 교환/환불 등 의무와 책임을 부담하지
