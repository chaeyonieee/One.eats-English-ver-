        ...
        <div class="main-wrap">
          ...
          <div class="agreement-container">
            ...
            <div class="row agreement_box_grid">
              <div class="col">
                <div class="row toggle-btn border-bottom">
                  <div class="col">[Mandatory] Service Usage agree to the Terms</div>
                ...
                <div class="row">
                  <div class="col-md agreement_box_col">
                    <span>Agree to the terms and conditions of the content.</span>
            ...
            <div class="row agreement_box_grid">
              <div class="col">
                <div class="row toggle-btn border-bottom">
                  <div class="col">[Mandatory] Agree to the collection and use of personal information</div>
                  <div class="float-right">
                    <img
                      class="agreement_arrow_icon"
                      src="${contextPath}/img/icon/downarrow.png"
            ...
            <div class="row agreement_box_grid">
              <div class="col select-check">
                <div class="row border-bottom">
                  <div class="col">
                    [Optional] Consent to receive information and benefits such as urgent Discount Price<br />
                  </div>
                </div>
                <div class="row">
                  <div class="col agreement_box_col">
