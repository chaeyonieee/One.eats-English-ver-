  ...
  <body>
    ...
    <table border="0" class="textcolor-black textsize-1">
      <tr>
        ...
        <th>Hot DealRegistration Date</th>
        <th>Hot DealProduct Name</th>
        ...
        <tr>
          ...
          <td style="text-align: right">
            <a
              ...
              onclick='fn_openalert("Do you want to delete the Hot Deal?","${contextPath }/admin/hotdeal/deleteHotdealGoods.do?hotdealNo=${hotdeal.hotdealNo}")'
              >Delete</a
            >
          </td>
        </tr>
