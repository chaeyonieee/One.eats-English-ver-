...
<html lang="en">
  ...
  <body>
    <div class="div-p">
      <p class="textsize-2 text-left textcolor-black textbold">Product</p>
        ...
        <tr>
          ...
          <td style="text-align: right">
            <a
              ...
              onclick='fn_openalert("Do you want to delete the product?","${contextPath }/admin/goods/deleteAdminSellerGoods.do?goodsNo=${goods.goodsNo}")'
              >Delete</a
            >
          </td>
        </tr>
